...
function buildTicketIngresso(sosta, nomeGarage, garage) {
  ...
  let bytes = [
    ...
    ...CMD.ALIGN_CENTER,
    ...CMD.BOLD_ON, ...testoBytes(nomeGarage.toUpperCase()), LF, ...CMD.BOLD_OFF,
    ...CMD.BOLD_ON, ...testoBytes('** INGRESSO **'), LF, ...CMD.BOLD_OFF,
    ...CMD.ALIGN_LEFT,
    ...testoBytes('Targa    : '), ...CMD.BOLD_ON, ...testoBytes(sosta.targa), ...CMD.BOLD_OFF, LF,
    ...testoBytes('Categoria: ' + (cat?.label || sosta.tipo_veicolo)), LF,
    ...(sosta.modello_auto ? [...testoBytes('Modello  : ' + sosta.modello_auto), LF] : []),
    ...testoBytes('Ingresso : ' + data + ' ' + ora), LF,
    ...CMD.ALIGN_CENTER,
...
function buildTicketUscita(sosta, nomeGarage, garage) {
  ...
  let bytes = [
    ...
    ...CMD.ALIGN_CENTER,
    ...CMD.BOLD_ON, ...testoBytes(nomeGarage.toUpperCase()), LF, ...CMD.BOLD_OFF,
    ...CMD.BOLD_ON, ...testoBytes('** USCITA **'), LF, ...CMD.BOLD_OFF,
    ...CMD.ALIGN_LEFT,
    ...testoBytes('Targa    : '), ...CMD.BOLD_ON, ...testoBytes(sosta.targa), ...CMD.BOLD_OFF, LF,
    ...testoBytes('Categoria: ' + (cat?.label || sosta.tipo_veicolo)), LF,
    ...(sosta.modello_auto ? [...testoBytes('Modello  : ' + sosta.modello_auto), LF] : []),
    ...
    ...CMD.ALIGN_CENTER,
    ...CMD.BOLD_ON, ...testoBytes('IMPORTO: ' + importo), LF, ...CMD.BOLD_OFF,
    ...testoBytes('Grazie per aver scelto ' + nomeGarage), LF,
    LF, LF,
    ...CMD.CUT,
  ];
  return bytes;
